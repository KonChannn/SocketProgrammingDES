...
def str_to_bin(user_input):
        ...
        # print("user_input", user_input, "length", len(user_input))
...
def ip_on_binary_rep(binary_representation):
    # print("ip_on_binary", binary_representation, len(binary_representation))
...
# test = binary_to_string("1001101011010000101101001111100010110110101010110110000000000111")
# print(test)